...
export default function FAQ({ faq: faqRaw }) {
    ...
    return (
        <section className="flex flex-col p-10 pt-16 items-center md:p-20 md:py-16 md:pt-32 lg:px-32 lg:pb-24 lg:pt-32 xl:px-40 xl:pb-32 xl:pt-36 items-left bg-emerald-800 z-10 relative" id="FAQ">
