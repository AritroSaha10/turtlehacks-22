...
import { eventTimeShort, registrationLink, mentorRegistrationLink, workshopLeadRegistrationLink, volunteerRegistrationLink, openingCeremonyLink, devpostLink } from '@util/config';
